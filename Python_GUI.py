...
temperature_mode_button = ttk.Radiobutton(mode_selection_frame, text="Temperature Sensing Mode", variable=mode_var,
                                          value=0, command=temperature_sensing_mode)
temperature_mode_button.grid(row=0, column=0, padx=10)

manual_mode_button = ttk.Radiobutton(mode_selection_frame, text="Manual Control Mode", variable=mode_var, value=1,
                                     command=lambda: manual_control(False))
...
fan_on_button = ttk.Radiobutton(manual_control_frame, text="Fan ON", variable=fan_status, value=1,
                                command=lambda: manual_control(True))
fan_on_button.grid(row=0, column=0, padx=10)

fan_off_button = ttk.Radiobutton(manual_control_frame, text="Fan OFF", variable=fan_status, value=0,
                                 command=lambda: manual_control(False))
